...
EVENT_MESSAGE_PKT = ccsdspy.VariableLength([
    ...
    ccsdspy.PacketField(name='ELID_EVTPKT', bit_length=8, data_type='uint'),  # bin_str
...
METADATA_FIELDS = [
    ...
    ccsdspy.PacketField(name='TIMESTAMP2_SUBSECONDS', bit_length=16, data_type='uint'),  # 20usec per DN
    # ccsdspy.PacketField(name='EVENTNUMBER_PAD1', 1, data_type.PADDING),
    ccsdspy.PacketField(name='EVENTNUMBER_TRIGGER_OFFSET', bit_length=3, data_type='uint'),
    # ccsdspy.PacketField(name='EVENTNUMBER_PAD2', 2, data_type.PADDING),
    ccsdspy.PacketField(name='EVENTNUMBER_TRIGGER_ORIGIN', bit_length=10, data_type='uint'),
    ccsdspy.PacketField(name='EVENTNUMBER_REMAINDER', bit_length=16, data_type='uint'),  # rolling over from 0xFFFF to 0
    # NBLOCKS_structure,
    ...
    ccsdspy.PacketField(name='TRIGGERMODE_HVPS_POLARITY', bit_length=1, data_type='uint'),
    # ccsdspy.PacketField(name='TRIGGERMODE_PAD', 22, data_type.PADDING),
    ccsdspy.PacketField(name='TRIGGERMODE_EXTERNAL_TRIGGER_POLARITY', bit_length=1, data_type='uint'),
    ccsdspy.PacketField(name='TRIGGERMODE_LSADC_COINCIDENCE_MODE', bit_length=1, data_type='uint'),
    ccsdspy.PacketField(name='TRIGGERMODE_LSADC_TRIGGER_ENABLE', bit_length=1, data_type='uint'),
